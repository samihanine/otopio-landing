...
export function Pagination() {
  return (
    <div className="mt-20 flex items-center justify-center gap-2">
      ...
      <span className="inline-flex h-10 w-10 items-center justify-center rounded-full bg-slate-50 text-sm font-medium text-slate-500/60 shadow-sm shadow-sky-100/50 ring-1 ring-slate-900/5">
        ...
      </span>
      <Link
        href="#"
