          ...
          <div className="lg:columns-2 lg:gap-8">
            <div className="relative bg-slate-50 px-5 py-16 sm:px-6 sm:py-24 lg:col-span-6 lg:rounded-br-[64px] lg:px-8 lg:pt-32 2xl:pl-0">
              ...
              <div className="relative mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
                <h2 className="font-display text-3xl font-semibold leading-tight text-slate-900 sm:text-4xl sm:leading-tight lg:text-[40px] lg:leading-tight xl:text-4xl xl:leading-tight">
                  {t("contact.title")}
                      ...
                      <div className="mt-4 space-y-3">
                        <div className="flex items-start">
                          ...
                          <div className="ml-3 text-sm leading-6">
                            <label htmlFor="web" className="text-slate-700">
                              {t("contact.form.services.website")}
                            </label>
                          </div>
                        </div>
                        <div>
                          <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm leading-6">
                              ...
                              >
                                {t("contact.form.services.design")}
                              </label>
                            </div>
                          </div>
                        </div>
                        <div>
                          <div className="flex items-start">
                            ...
                            <div className="ml-3 text-sm leading-6">
                              <label htmlFor="app" className="text-slate-700">
                                {t("contact.form.services.app")}
                              </label>
                            </div>
                          </div>
                        </div>
