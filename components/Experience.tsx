...
export function Experience() {
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-50 via-slate-50 to-white pt-20 pb-40 sm:pt-24 lg:pt-32 lg:p-44">
      <Container>
        <h2 className="font-display text-4xl font-semibold text-slate-900 sm:text-5xl text-center">
          We're your{" "}
